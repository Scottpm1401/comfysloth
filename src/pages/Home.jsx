...
export default class Home extends Component {
  ...
  componentDidMount = async () => {
    const result = await axiosClient.get(API.FEATURED);
    ...
    return (
      <React.Fragment>
        <section className="section_1 container">
          <article className="section_1_content">
            <h1 className="section_1_title">
              design your
              <br />
              comfort zone
            </h1>
            <p className="section_1_text">
            ...
            <Link className="btn hero_btn" to="/products">
              SHOP NOW
            </Link>
          </article>
          <article className="section_1_img">
            <img
              className="main_img"
        ...
        <section className="section_2">
          <div className="section_2_header container">
            <h2 className="featured_title">Featured Products</h2>
            <div className="underline"></div>
          </div>
          <div className="section_2_featured container">
            {this.state.data.length > 0 ? (
              this.state.data.map((product) => {
                const { title, img, price, id } = product;
                return (
                  <article className="featured_product" key={id}>
                    <div className="featured_product_img_crl">
                      <img
                    ...
                    <div className="featured_product_content">
                      <h3 className="featured_product_title">{title}</h3>
                      <h3 className="featured_product_price">${price}</h3>
                    </div>
                    <div className="featured_btn_crl">
          ...
          <Link className="section_2_btn btn" to="/products">
            ALL PRODUCTS
          </Link>
        </section>
        <section className="section_3">
          <div className="section_3_center container">
            ...
            <div className="section_3_services">
              <article className="service">
                ...
                <h4 className="service_name">Mission</h4>
              ...
              <article className="service">
                ...
                <h4 className="service_name">Vision</h4>
                <p className="service_content">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Voluptates, ea. Perferendis corrupti reiciendis nesciunt rerum
                  velit autem unde numquam nisi
              ...
              <article className="service">
                ...
                <h4 className="service_name">History</h4>
                <p className="service_content">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Voluptates, ea. Perferendis corrupti reiciendis nesciunt rerum
                  velit autem unde numquam nisi
        ...
        <section className="section_4 container">
          ...
          <div className="section_4_content">
            ...
            <form className="section_4_email">
              <input
                className="input_email"
                type="email"
                placeholder="Enter Email"
              />
              <button type="submit" className="subcribe_btn">
                Subscribe
              </button>
            </form>
          </div>
